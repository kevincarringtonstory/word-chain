  ...
  const handleDelete = () => {
    if (state.attempts.length > 0) {
      setState((prev) => ({
        ...
        currentWord:
          prev.attempts.length > 1
            ? prev.attempts[prev.attempts.length - 2]
            : prev.startWord,
      }));
    }
  };
  ...
  return (
    <div className="h-screen flex flex-col bg-white overflow-hidden">
      <div className="flex-1 flex flex-col w-full max-w-lg mx-auto p-2 sm:p-4">
        <header className="w-full max-w-[500px] mx-auto bg-white shadow-sm flex items-center justify-between mb-1 sm:mb-2 relative">
          <button
        ...
        <main className="flex-1 flex flex-col">
          ...
          <div className="flex-1 flex flex-col justify-between">
            <div className="mb-1 sm:mb-2 text-center">
              <div className="flex justify-center items-center space-x-2 sm:space-x-4 mb-1 sm:mb-2">
                <div
                  key={
                  ...
                  className="text-2xl sm:text-4xl font-bold p-2 sm:p-4 bg-blue-100 rounded-lg shadow-md spin-animation"
                >
                  {state.attempts.length > 0
                    ? state.attempts[state.attempts.length - 1]
                    : state.startWord}
                ...
                <div className="text-2xl sm:text-4xl font-bold p-2 sm:p-4 bg-green-100 rounded-lg shadow-md">
                  {state.endWord}
                </div>
              </div>
              ...
              <div className="grid grid-cols-5 gap-1 mb-1 sm:mb-2">
                {Array(10)
                  ...
                  .map((_, index) => (
                    <div
                      key={index}
                      className={`border p-1 text-center h-6 sm:h-8 flex items-center justify-center text-xs sm:text-sm ${
                ...
                <>
                  <div className="mb-1 sm:mb-2">
                    <input
                      ...
                      className={`w-full py-2 sm:py-3 px-2 border-2 border-blue-300 rounded-lg text-lg sm:text-xl text-center font-bold tracking-wider focus:outline-none focus:border-blue-500 transition-all duration-100 ${
                  ...
                  <div className="flex justify-between mb-1 sm:mb-2">
                    <button
                      ...
                      className="w-1/2 mr-1 py-1 sm:py-2 px-2 sm:px-4 bg-gray-200 text-gray-800 rounded-lg font-bold text-sm sm:text-base hover:bg-gray-300 transition-colors"
                    >
                      Delete
                    </button>
                    <button
                      onClick={handleRestart}
                      className="w-1/2 ml-1 py-1 sm:py-2 px-2 sm:px-4 bg-gray-200 text-gray-800 rounded-lg font-bold text-sm sm:text-base hover:bg-gray-300 transition-colors"
                    >
                      Restart
                    </button>
                  </div>
